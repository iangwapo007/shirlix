...
<template>
  <v-responsive>
    <v-app :theme="theme">
      <v-app-bar class="px-3" :color="theme === 'light' ? 'grey-lighten-1' : 'grey-darken-3'" app>
        <v-spacer></v-spacer>
      ...
      <v-footer
        class="text-center d-flex flex-column ga-2 py-4 mt-16"
      ...
      >
        ...
        <div class="text-caption font-weight-regular opacity-60 px-16">
        ...
        <div>{{ new Date().getFullYear() }} — <strong>Shirlix Meatshop</strong></div>
      </v-footer>
    </v-app>
  </v-responsive>
</template>
